...
- made by group of students in aiml class of Jayanthi J . for project based work :
  - Aiman (Group Leader)
  - Aritra
  - Nitin
  - Lavanya
...
TO use the project in your own pc u need to install the requirements:
```
pip3 install -r requirements.txt
```

### Dataset
This project used 4 datasets (including this repo's custom dataset) which are downloaded and formatted already in `data` folder:
